...
public class ThrowStatement extends Statement {
  ...
  @Override
	public boolean equal(Statement stm) {
	  if (!(stm instanceof ThrowStatement))
		  return false;
	  
	  ThrowStatement throwStm = (ThrowStatement)stm;
	  return _expr.toString().equals(throwStm._expr.toString());
	}
  
  @Override
	public String toString() {
	  return "throw " + _expr.toString() + ";";
	}
}
