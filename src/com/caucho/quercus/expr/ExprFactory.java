...
public class ExprFactory {
  ...
  */
  ...
  {
	// CODE ADDED BY SON
	  Statement stm = new ClassDefStatement(loc, cl);
	  
	  if (cl.getName().equals(Env_.testClass))
		  Env_.testCaseMap.put(cl.getName(), (ClassDefStatement) stm);
	  if (cl.getParentName() != null){
		  if (cl.getParentName().equals(Env_.testClass))
			  Env_.testCaseMap.put(cl.getName(), (ClassDefStatement) stm);
	  }
